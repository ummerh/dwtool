...
/**
 * This class is a utility which will do copying of attributes from a original
 * object to destination object. Intention was to provide a attribute value
 * copying mechanism which is less expensive than ObjectUtils.deepCopy() method
 */
public final class ObjectValueUtils {
    ...
    /**
     * This method uses simple getter/setter methods to copy object values from
     * a original object to destination object
     * 
     * @param origin
     *            original object
     * @param destination
